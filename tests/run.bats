...
@test "Run without a prebuilt image" {
  ...
  stub docker-compose \
    ...
    "-f docker-compose.yml -p buildkite1111 run --name buildkite1111_myservice_build_1 myservice /bin/bash -c 'echo hello world' : echo ran myservice"
...
@test "Run without a prebuilt image with a complicated command" {
  ...
  stub docker-compose \
    "-f docker-compose.yml -p buildkite1111 build --pull myservice : echo built myservice" \
    "-f docker-compose.yml -p buildkite1111 run --name buildkite1111_myservice_build_1 myservice /bin/bash -c '$BUILDKITE_COMMAND' : echo ran myservice"
...
@test "Run without a prebuilt image with custom env" {
  ...
  stub docker-compose \
    "-f docker-compose.yml -p buildkite1111 build --pull myservice : echo built myservice" \
    "-f docker-compose.yml -p buildkite1111 run --name buildkite1111_myservice_build_1 -e MYENV=0 -e MYENV -e MYENV=2 -e MYENV myservice /bin/bash -c 'pwd' : echo ran myservice"
...
@test "Run with a prebuilt image" {
  ...
  stub docker-compose \
    ...
    "-f docker-compose.yml -p buildkite1111 -f docker-compose.buildkite-1-override.yml run --name buildkite1111_myservice_build_1 myservice /bin/bash -c pwd : echo ran myservice"
...
@test "Run with a prebuilt image and custom config file" {
  ...
  stub docker-compose \
    ...
    "-f tests/composefiles/docker-compose.v2.0.yml -p buildkite1111 -f docker-compose.buildkite-1-override.yml run --name buildkite1111_myservice_build_1 myservice /bin/bash -c pwd : echo ran myservice"
...
export BUILDKITE_JOB_ID=1111
  ...
  stub docker-compose \
    ...
    "-f tests/composefiles/docker-compose.v2.0.yml -f tests/composefiles/docker-compose.v2.1.yml -p buildkite1111 -f docker-compose.buildkite-1-override.yml run --name buildkite1111_myservice_build_1 myservice /bin/bash -c pwd : echo ran myservice"
...
@test "Run without a TTY" {
  ...
  stub docker-compose \
    "-f docker-compose.yml -p buildkite1111 -f docker-compose.buildkite-1-override.yml pull myservice : echo pulled myservice" \
    "-f docker-compose.yml -p buildkite1111 -f docker-compose.buildkite-1-override.yml run --name buildkite1111_myservice_build_1 -T myservice /bin/bash -c pwd : echo ran myservice without tty"
...
@test "Run without dependencies" {
  ...
  stub docker-compose \
    "-f docker-compose.yml -p buildkite1111 -f docker-compose.buildkite-1-override.yml pull myservice : echo pulled myservice" \
    "-f docker-compose.yml -p buildkite1111 -f docker-compose.buildkite-1-override.yml run --name buildkite1111_myservice_build_1 --no-deps myservice /bin/bash -c pwd : echo ran myservice without dependencies"
...
@test "Run with multiple config files" {
  ...
  stub docker-compose \
    ...
    "-f llamas1.yml -f llamas2.yml -f llamas3.yml -p buildkite1111 run --name buildkite1111_myservice_build_1 myservice /bin/bash -c 'echo hello world' : echo ran myservice"
...
@test "Run with a failure still runs cleanup" {
  ...
  stub docker-compose \
    "-f docker-compose.yml -p buildkite1111 build --pull myservice : echo built myservice" \
    "-f docker-compose.yml -p buildkite1111 run --name buildkite1111_myservice_build_1 myservice /bin/bash -c pwd : exit 1" \
...
@test "Run with a failure should expand previous group" {
  ...
  stub docker-compose \
    "-f docker-compose.yml -p buildkite1111 build --pull myservice : echo built myservice" \
    "-f docker-compose.yml -p buildkite1111 run --name buildkite1111_myservice_build_1 myservice /bin/bash -c pwd : exit 2"
...
@test "Run with multiple prebuilt images and multiple pulls" {
  ...
  stub docker-compose \
    ...
    "-f docker-compose.yml -p buildkite1111 -f docker-compose.buildkite-1-override.yml run --name buildkite1111_myservice1_build_1 myservice1 /bin/bash -c pwd : echo ran myservice1"
